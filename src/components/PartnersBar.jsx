    ...
    <section className="bg-bg border-y-2 border-orange py-12">
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div className="flex justify-center md:justify-end items-center gap-10 flex-wrap">
          ...
          <img src="/logos/adidaslogo.png" alt="Adidas Careers" className="h-40 sm:h-44 object-contain" />
        </div>
        ...
        <div className="text-center md:text-left">
          ...
          <p className="font-adi text-base md:text-2xl max-w-xl"> {/* @media -> md:768px*/}
