  ...
  const sendEmailSummary = async (requestId) => {
    try {
      ...
      if (response.data.success) {
        ...
        showEmailNotification("❌ Error sending email", "error", requestId);
        return false;
      }
    } catch (error) {
              ...
              >
                ...
                <td className="py-4 px-6">
                  <span
                    ...
                    ${
                      asset.type.toLowerCase().includes("audio")
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between mb-4">
                      <span className="text-2xl text-orange font-adi p-6">
                        {icon} {label}
                      </span>
  ...
  return (
    ...
    >
      ...
      {isIndividualModalOpen && individualAsset && (
        <AssetModal asset={individualAsset} onClose={closeIndividualModal} />
      )}
    </div>
  );
};
